                            ...
                            @if(count($videos) > 0)
                                <div class="flex items-center space-x-2">
                                    <button wire:click="deleteSelectedVideos" 
                                            @disabled(empty($selectedVideos))
                                            class="px-3 py-2 text-sm font-medium text-red-600 hover:text-red-500 disabled:text-gray-400 disabled:cursor-not-allowed">
                                    ...
                                    <button wire:click="clearPlaylist"
                                            ...
                                            class="px-3 py-2 text-sm font-medium text-red-600 hover:text-red-500 border border-red-300 rounded-md hover:border-red-400">
                                        Clear Playlist
                                    </button>
                                </div>
                            @endif
